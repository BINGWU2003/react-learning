...
import reactModelSource from "./react-update-model.ts?raw";
import vueDemoSource from "./VueDemo.vue?raw";
import vueModelSource from "./vue-reactivity-model.ts?raw";
...
<SourceCodeTabs
  ...
  files={[
    ...
    { title: "react-update-model.ts", lang: "ts", code: reactModelSource },
  ]}
/>
...
<SourceCodeTabs
  ...
  files={[
    ...
    { title: "vue-reactivity-model.ts", lang: "ts", code: vueModelSource },
  ]}
/>
